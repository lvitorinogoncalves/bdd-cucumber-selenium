...
public class DefinicaoPassosComArgumentos {
    ...
    @Quando("Eu adiciono o livro {livroCucumber}")
    public void euAdicionoOLivro(Livro livroCucumber) {
        ContextoDeTeste.INSTANCIA.biblioteca().adiciona(livroCucumber);
    }

    @ParameterType(".*")
    public Livro livroCucumber(String descricaoLivro) {
